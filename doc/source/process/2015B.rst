...
+            +           +--------------------------------------+-----------+
|            |           | Deprecated items selected            | DefCore   |
+------------+-----------+--------------------------------------+-----------+
...
A3. DefCore Collects Recommendations for Designated Sections
  ...
  1. Designated Sections will not be removed without being deprecated in the
     previous Guideline.
  2. Designated Sections will not be added unless the corresponding code
     base is designated as part of the "TC-approved release"
     by the Technical Committee (see bylaws of the Foundation, section
     4.1(b)(iii)).
  3. Technical leadership may, but is not required to, assist DefCore with
     defining designated sections for projects that have required
     capabilities.
